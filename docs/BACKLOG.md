...
| 21 | KEEP_PREVIOUS for data-writing steps must copy their data files | 8 | DOING | Hook `StepImpl.keep_data` exists; step 2 implements it (refuses when the old confirmation misses a camera enabled now). Each later data-writing page must too |
