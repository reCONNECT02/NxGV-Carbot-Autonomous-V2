...
3 (camera intrinsics), 5 (LiDAR-camera alignment) and 6 (IMU + wheel odometry) done**;
the other steps are placeholder pages; race mode (preflight / READY / START) not started.
