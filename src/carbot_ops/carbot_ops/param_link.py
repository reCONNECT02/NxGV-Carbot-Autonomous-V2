...
reply inside a callback (calib_tools.RemoteParams spins its own loop and would
...
Step 9 uses it for road_perception classify.*. (Same pattern as the step 6/7
servo_controller link; the two can be merged when both branches are in.)
"""
import time
